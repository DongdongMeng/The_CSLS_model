...
Matlab 2014a version above

Test the model:

There is one investigated image sample named demo.tif. You can run the main function The_CSLS_model.m for test.

The following four dynamic maps showthe processes of green algae detection by our context-sensitive level sets (CSLS) model.
